                ...
                child: Center(
                  child: Column(
                    ...
                    first_reach ? Text(title,
                                  ...
                                  softWrap: true,) : 
                          Text (title,
                          style: Theme.of(context).textTheme.titleMedium!.copyWith(color: success ? Colors.green : Colors.red, fontSize: 30),
                          softWrap: true,),
                    Padding(
                      padding: const EdgeInsets.all(10.0),
                      child: first_reach ? const Icon(Icons.bluetooth,size: 50,) : 
                              (success ? const Icon(Icons.check_circle,size: 50,color: Colors.green,) : const Icon(Icons.error,size: 50, color: Colors.red,)),
                    ),
                    Padding(
