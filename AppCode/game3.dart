          ...
          displayText(
                 Column(
                  ...
                  children: [
                      ...
                      Text("$avgWinner",style: Theme.of(context).textTheme.bodyMedium,)
                  ],),3
              ),
          const Spacer(),
//------------------------------------------Looser Clicks per Second----------------------------------//
          displayText(
                 Column(
                  ...
                  children: [
                      Text("Clicks per second:",style: Theme.of(context).textTheme.titleSmall, textAlign: TextAlign.center,),
                      Text("$avgLooser",style: Theme.of(context).textTheme.bodyMedium,)
                  ],),4
          ),
          const Spacer(),
        ],),
...
//----------------------------------------Clicks Number------------------------------------------//
         displayText(
                 Column(
                  ...
                  children: [
                      Text("Number of Clicks:",style: Theme.of(context).textTheme.titleSmall, textAlign: TextAlign.center,),
                      Text("$clicks1",style: Theme.of(context).textTheme.bodyMedium,)
                  ],),4
              ),
          const Spacer(),
//-----------------------------------------Clicks per Second------------------------------------//
