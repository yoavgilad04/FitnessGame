...
var colorstrings = <String>['Blue','Yellow','Orange','Purple','Brown','Pink'];
                        ...
                        child: ElevatedButton(
                          onPressed: () => {
                              if(_validateName.currentState!.validate() && _validateTime.currentState!.validate())//the inputs are fine
                              {
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => Game2Timer(homescreen: widget.homescreen,time: time_chosen, color: color_chosen)),
                           )
                              }
                          }, 
                          child: Text("Start",
